...
(function() {
    ...
    angular.module("topicsApp").controller("imageUploadController", imageUploadController);

    function imageUploadController($scope, $routeParams) {
        $scope.fileList = [];
        $scope.curFile;
        $scope.ImageProperty = {
            file: ''
        ...
        $scope.UploadFileIndividual = function (fileToUpload, name, type, size, index) {
            ...
            reqObj.open("POST", "ImageUpload/UploadFiles", true);
